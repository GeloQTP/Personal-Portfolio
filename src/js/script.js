...
contact_button.onclick = function(){ // opens development's modal
    contact.style.display = "block"; // display the modal
    contact.classList.add("show"); // the animation
}

close_contact_modal.onclick = function(){ // closes developments modal
...
const close_development_modal = document.getElementById("close-development-modal");

developments_button.onclick = function(){ // opens development smodal
    developments.style.display = "block"; // display the modal

    developments.classList.add("show"); // the animation
}

close_development_modal.onclick = function(){ // closes developments modal
...
const close_illustrations_modal = document.getElementById("close-illustrations-modal");
